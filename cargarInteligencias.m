clc
[images,labels] = cargarImagenes('train-images.idx3-ubyte','train-labels.idx1-ubyte');
DataSet=construirDataSet(images,labels);
global knn tree;
knn = trainClassifierKNN1(DataSet);
tree = trainClassifierTree(DataSet);
%%
function [images, labels] = cargarImagenes(path_to_digits, path_to_labels)
